...
/**
 * @brief   Configures P8.0, P8.5, P8.6, P8.7 as GPIO outputs and clears them
 *          by clearing these bits on the SEL0, SEL1, and OUT registers
 *          and setting these bits on the DIR register
 *
 * @param None
 *
 * @return None
