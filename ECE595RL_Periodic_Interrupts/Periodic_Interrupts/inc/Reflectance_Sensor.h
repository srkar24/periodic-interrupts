...
/**
 * @brief Turns on and sets IR LEDs and configures as inputs after 10us.
 *
 * This function performs the following steps:
 * 1. Turns on the 8 IR LEDs.
 * 2. Makes the sensor pins output.
 * 3. Sets the sensor pins.
 * 4. Waits for 10us.
 * 5. Makes the sensor pins input.
 *
 * @param None
 *
 * @return None
...
/**
 * @brief Reads and returns the value of the reflectance sensor.
 *
 * This function performs the following steps:
 * 1. Stores the value of the P7 IN register in reflectance_value.
 * 2. Turns off the 8 IR LEDs.
 * 3. Returns reflectance_value.
 *
 * @param None
 *
 * @return uint8_t reflectance_value
 */
